...
def init_instrumentation():
    ...
    if not config.PHOENIX_API_KEY and "localhost" in config.PHOENIX_COLLECTOR_ENDPOINT:
        ...
        try:
            ...
            print(f"[Phoenix] Warning: Could not launch local server (it might already be running): {e}")
    ...
    print("[Phoenix] Tracer successfully registered and auto-instrumentation activated.")
